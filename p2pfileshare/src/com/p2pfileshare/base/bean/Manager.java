 ...
 */  
package com.p2pfileshare.base.bean;
import java.io.File;
...
import com.p2pfileshare.base.fun.ChanAdvertiserThread;
import com.p2pfileshare.base.fun.FileSharing;
import com.p2pfileshare.base.fun.PrivateConversation;
import com.p2pfileshare.base.message.AttachmentMessage;
import com.p2pfileshare.base.message.ChannelMessage;
import com.p2pfileshare.base.message.Message;
import com.p2pfileshare.base.message.PrivateMessage;
import com.p2pfileshare.base.message.ServiceMessage;
import com.p2pfileshare.base.message.SharingListMessage;
import com.p2pfileshare.base.net.MulticastDispatcher;
import com.p2pfileshare.base.net.NetworkDispatcher;
import com.p2pfileshare.base.ui.FileDialog;
import com.p2pfileshare.base.ui.recvFilesFrame;
import com.p2pfileshare.base.ui.peerShareFrame;
...
public class Manager {
    ...
    private void ParseServiceMessage(ServiceMessage iMsg){
    	System.out.println("我在方法ParseServiceMessage内");
        if(!iMsg.IsBroadcast() && !iMsg.GetToUser().equals(GetMe()))
            return;
        
        switch(iMsg.GetCode()){
            case ServiceMessage.CODE_CHAN_ADV:{
            	System.out.println("我接收到了CODE_CHAN_ADV信息");
            ...
            case ServiceMessage.CODE_JOIN:{
                if(curChan==null){//我加入了频道
                    ReqChan=iMsg.GetArg();
                    System.out.println("我收到CODE_JOIN广播");
                }else{//其它的Peer加入
                	System.out.println("其他peer收到CODE_JOIN广播");
