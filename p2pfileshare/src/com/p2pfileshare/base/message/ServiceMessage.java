 ...
 * @author yb
 * @version 1.0  
 * 聊天系统发出的用于同步和管理的信息，比如通知peer节点加入或退出的信息等。  
 */
import java.io.*;
...
public class ServiceMessage extends Message implements Serializable{
    ...
    public boolean IsBroadcast(){//是否为广播信息
        return to==null;
    }
    ...
    //构造方法1
    public ServiceMessage(Peer iFrom,Peer iTo,char iCode,String iArg) {//消息编码icode，消息内容igra
